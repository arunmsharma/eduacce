package com.arun.eduacce.security;
...
@Component
public class EduacceUsernamePwdAuthenticationProvider
        implements AuthenticationProvider
{
    ...
    public Authentication authenticate(Authentication authentication)
        ...
        String email = authentication.getName(); //email will be used as username
